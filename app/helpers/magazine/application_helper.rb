module Magazine
  module ApplicationHelper
    ...
    # Format content using the {Magazine::Configuration#default_parser_class default_parser_class}
    def format_content(content = nil, &block)
      content = capture(&block) if block_given?
      parser = Magazine::configuration.default_parser_class.new(content)
    ...
    def errors_on(object, attribute)
      ...
      content_tag(:span, error_message, :class => "magazine_error_message") if error_message
    end
    ...
    def login_required(content_or_options={}, options ={}, &block)
      if current_blogger and magazine_conf.include_admin_links
