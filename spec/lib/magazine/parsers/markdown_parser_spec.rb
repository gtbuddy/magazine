...
describe Magazine::Parsers::MarkdownParser do

  let(:parser) { Magazine::Parsers::MarkdownParser.new("## Some textile\n\nA paragraph") }
  ...
  describe "code highlighting" do
    ...
    let(:parser) { 
      Magazine::Parsers::MarkdownParser.new("## Header\n\n``` ruby\nputs 'hello world'\n```") 
    }

    it "should highlight code if highlight_code_syntax is true" do
      Magazine::configuration.highlight_code_syntax = true
    ...
    it "shoud not highlight code if highlight_code_syntax is false" do
      Magazine.configuration.highlight_code_syntax = false
