...
describe CommentsController do
  ...
  let(:article) { Magazine::Article.first || create(:article) }
  ...
  describe "POST create" do
    ...
    def do_article(format = :html)
      article :create, article_id: article.id, 
        comment: @comment_attributes, use_route: :magazine, format: format
    end
  ...
  describe "DELETE destroy" do
    ...
    def do_delete(format = :html)
      delete :destroy, id: @comment.id,
        article_id: article.id, format: format, use_route: :magazine
    end
